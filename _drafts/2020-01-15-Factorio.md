...
Mine Huge Rock
Place [Added Front1tb][iPad] Burner miner, 2/3 fuel
Place [added Arch5Shuttle2] furnace 1/3 fuel
Mine [added Arch5Shuttle2] other huge [iPad] rocks
build 1 buner miner, 2 furnace
For this run, [iPad] you will need to mine 115 iron and 34 copper. I would suggest doing the iron first.
...
* Pump [Added Front1tb][added Arch5Shuttle2] (8 crafts total) [iPad] = 1 craft + 1 pipe (1 craft) + 1 gear (1 craft) + 2 green boards (5 crafts = 2 crafts + 6 copper cables [3 crafts] + 2 iron [0 crafts])
* Boiler [iPad] (5 craft total) = [added Arch5Shuttle2] 1 craft + Furnace (0 crafts) + 4 pipe (4 crafts)
